        ...
        <Page header footer>
            <main className="container">
                ...
                <div className="buttons around">
                    <Button
                        variant="contained"
                        onClick={() => setRecordNumber(250)}
                    >
                        250 Records
                    </Button>
                    <Button
                        variant="contained"
                        onClick={() => setRecordNumber(500)}
                    >
                        500 Records
                    </Button>
                    <Button
                        variant="contained"
                        onClick={() => setRecordNumber(1000)}
                    >
                        1000 Records
                    </Button>
                    <Button
                        variant="contained"
                        onClick={() => setRecordNumber(2000)}
                    >
                        2000 Records
                    </Button>
                </div>
                ...
                <SChart
                    data={vitals.getVitalByOrganization.slice(0, recordNumber)}
                />
                <BChart
                    data={vitals.getVitalByOrganization.slice(0, recordNumber)}
                />
