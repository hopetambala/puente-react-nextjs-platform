        ...
        <div key={item.id}>
          ...
          {doubleLoop === true && (
            <h5 className={styles.error}>
              ERROR! Your repeat group contains another repeat group, your form
              will break!
            </h5>
          )}
          ...
          {repeatQuestionsExceeded === true && (
            <h5 className={styles.error}>
              ERROR! You have repeated more questions than exist prior to the
              loop! Change value now!
            </h5>
          )}
          {loopCount > 1 && (
            <h5 className={styles.error}>
              ERROR! There should be only one geolocation field per form. Remove
