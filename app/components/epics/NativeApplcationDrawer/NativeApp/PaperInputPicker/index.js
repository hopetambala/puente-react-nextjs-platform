...
import { styleButton, stylesDefault, stylesPaper, styleX } from './index.style'
import Looper from './Looper'

const PaperInputPicker = ({ data }) => {
        ...
        <>
            ...
            {fieldType === 'numberInput' && (
                <View style={stylesDefault.container} key={formikKey}>
                    ...
                    <TextField
                        label={
                            translatedLabel.length > 30 ? '' : translatedLabel
                        }
                        variant="outlined"
            ...
            {(fieldType === 'autofill' || fieldType === 'autofillms') && (
                <View key={formikKey}>
                    <AutoFill translatedLabel={translatedLabel} />
                </View>
            )}
            {fieldType === 'geolocation' && (
                <Geolocation formikKey={formikKey} />
            )}
            {fieldType === 'header' && (
            ...
            {fieldType === 'loop' && (
                <View key={formikKey}>
                    <Looper translatedLabel={translatedLabel} />
                </View>
            )}
