...
import SentimentSatisfiedlIcon from '@material-ui/icons/SentimentSatisfied';
...
const icons = {
  ...
  assessments: AssignmentTurnedInIcon,
  ...
  circleSmall: FiberManualRecordIcon,
  claim: AccountBalanceIcon,
  close: CloseIcon,
  ...
  expandArrow: KeyboardArrowDownIcon,
  ...
  formatBulletedList: FormatListBulletedIcon,
  formatItalic: FormatItalicIcon,
  formatNumberedList: FormatListNumberedIcon,
  forum: ForumIcon,
  forward: ForwardIcon,
  gender: AccessibilityNewIcon,
  guide: MenuBook,
  heart: FavoriteIcon,
  help: HelpIcon,
  ...
  mail: MailIcon,
  mailbox: MarkunreadMailboxIcon,
  map: MapIcon,
  market: PlaceIcon,
  menu: MenuIcon,
  menuExpand: ArrowRightIcon,
  ...
  openCircle: RadioButtonUncheckedIcon,
  ...
  sentimentSatisfied: SentimentSatisfiedlIcon,
