...
import buttonStyles from '../button/css/button.css';
...
const renderHeaderCells = (header: cell) =>
...
export const Table = <Data extends IdentifiedRowData>({
  allRowsLength,
  className,
  columns,
  data,
            ...
            {table.getHeaderGroups().map((headerGroup: headerFooterGroup) => (
              ...
              >
                ...
                {headerGroup.headers.map((header: cell) => (
                  <TableCell key={header.id} isHeaderCell>
